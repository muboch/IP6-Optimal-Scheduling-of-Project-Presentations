            ...
            for (L l : lecturers) {
                ...
                for (R r : rooms) {
                    for (T t : timeslots) {
                        ...
                        getGrbModel().addGenConstrIndicator(currentRoomNotPrevRoom, 1, rhs, GRB.GREATER_EQUAL, 1, null);
                        getGrbModel().addGenConstrIndicator(currentRoomNotPrevRoom, 0, rhs, GRB.LESS_EQUAL, 0, null);
