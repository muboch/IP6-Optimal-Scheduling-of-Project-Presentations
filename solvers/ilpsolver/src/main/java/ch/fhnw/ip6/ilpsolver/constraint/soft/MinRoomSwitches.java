            ...
            for (L l : lecturers) {
                ...
                for (R r : rooms) {
                    for (T t : timeslots) {
                        ...
                        getGrbModel().addGenConstrIndicator(lecInRoomAtTime[indexOf(l)][indexOf(t)][indexOf(r)], 1, presAtTimeInRoom, GRB.GREATER_EQUAL, 1.0, null);
                        getGrbModel().addGenConstrIndicator(lecInRoomAtTime[indexOf(l)][indexOf(t)][indexOf(r)], 0, presAtTimeInRoom, GRB.LESS_EQUAL, 0.0, null);
                        ...
                        getGrbModel().addGenConstrIndicator(currentRoomNotPrevRoom, 1, linExprPrevRoom, GRB.GREATER_EQUAL, 1, null);
                        getGrbModel().addGenConstrIndicator(currentRoomNotPrevRoom, 0, linExprPrevRoom, GRB.LESS_EQUAL, 0, null);
